...
const caloriesProgress = dashboard
  ? (dashboard.calories.current / dashboard.calories.goal) * 100
  : 0;
...
const activityProgress = dashboard
  ? (dashboard.activity.current / dashboard.activity.goal) * 100
  : 0;
    ...
    <div className="min-h-screen p-4 md:p-8 pb-24 md:pb-8 bg-background transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-card rounded-3xl p-6 shadow-sm border border-sky-100/50 dark:border-gray-700/50">
            ...
            <div className="relative w-32 h-32 mx-auto mb-4">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <p className="text-2xl text-sky-900 dark:text-sky-100">{dashboard?.calories.current}</p>
                <p className="text-xs text-sky-600 dark:text-sky-400">{t('of', language)} {dashboard?.calories.goal}</p>
              </div>
            </div>
          ...
          <div className="bg-card rounded-3xl p-6 shadow-sm border border-sky-100/50 dark:border-gray-700/50">
            ...
            <div className="relative w-32 h-32 mx-auto mb-4">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <p className="text-2xl text-sky-900 dark:text-sky-100">{dashboard?.water.current}</p>
      ...
      {/* <div className="bg-card rounded-3xl p-6 shadow-sm border border-sky-100/50 dark:border-gray-700/50">
        ...
        <div className="space-y-4">
          {dashboard.timeline.map((item:any,index:number) => {
            ...
            return (
              <div key={`${item.time}-${index}`} className="flex items-start gap-4">
                ...
                <div className="flex-1 pb-2">
                  ...
                  <p className="text-sm text-sky-600 dark:text-sky-400">{item.value}</p>
                </div>
              </div>
            );
          })}
